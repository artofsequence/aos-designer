...
/**
 * @file
 * @brief Generated from name.xsd.
 */

#ifndef AOSLCPP_AOSL__NAME_HPP
#define AOSLCPP_AOSL__NAME_HPP
...
{
  /**
   * @brief Class corresponding to the %name schema type.
   *
   * Type for allowed names' syntax.
   *
   * @nosubgrouping
   */
