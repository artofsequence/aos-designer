...
/**
 * @file
 * @brief Generated from email.xsd.
 */

#ifndef AOSLCPP_AOSL__EMAIL_HPP
#define AOSLCPP_AOSL__EMAIL_HPP
...
{
  /**
   * @brief Class corresponding to the %email schema type.
   *
   * Valid email adress.
   *
   * @nosubgrouping
