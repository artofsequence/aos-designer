...
#ifndef AOSLCPP_AOSL__PROPERTIES_GRAPHIC_OBJECT_FORWARD_HPP
#define AOSLCPP_AOSL__PROPERTIES_GRAPHIC_OBJECT_FORWARD_HPP
...
namespace aosl
{
  class Properties_graphic_object;
}
...
#endif // AOSLCPP_AOSL__PROPERTIES_GRAPHIC_OBJECT_FORWARD_HPP
