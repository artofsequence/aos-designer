...
#ifndef AOSLCPP_AOSL__PROPERTIES_STREAM_OBJECT_FORWARD_HPP
#define AOSLCPP_AOSL__PROPERTIES_STREAM_OBJECT_FORWARD_HPP
...
namespace aosl
{
  class Properties_stream_object;
}
...
#endif // AOSLCPP_AOSL__PROPERTIES_STREAM_OBJECT_FORWARD_HPP
