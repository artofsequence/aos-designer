...
/**
 * @file
 * @brief Generated from targets.xsd.
 */

#ifndef AOSLCPP_AOSL__TARGETS_HPP
#define AOSLCPP_AOSL__TARGETS_HPP
...
{
  /**
   * @brief Class corresponding to the %targets schema type.
   *
   * @nosubgrouping
   */
  class Targets: public ::xml_schema::Type
  {
    public:
    /**
     * @name target
     ...
     * @brief Element type.
     */
    typedef ::aosl::Target TargetType;
     ...
     * instance.
     */
    Targets (const ::xercesc::DOMElement& e,
  ...
  bool
  operator== (const Targets&, const Targets&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const Targets&);
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const Targets&);
}
...
#endif // AOSLCPP_AOSL__TARGETS_HPP
